...
A token is used to verify that a person has the required authorization to access a webpage. For example, logging in successfully.

- [ ] What steps can you take in your web apps to keep your data secure?
You can create login systems, and create protected/private routes that require authorization to access

- [ ] Describe how web servers work.
Web servers process network requests, and store/process/deliver web pages to clients from a centralizated location
